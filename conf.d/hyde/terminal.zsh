...
HYDE_ZSH_PROMPT="0"     #Unset this variable in $ZDOTDIR/user.zsh to disable HyDE's prompt customization.
...
alias un='__package_manager remove'
alias up='__package_manager upgrade'
alias pl='__package_manager search installed'
alias pa='__package_manager search all'
alias vc='code'
